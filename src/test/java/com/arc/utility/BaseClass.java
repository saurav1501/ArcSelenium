...
public class BaseClass {
	...
	public static File extentconfigfile = new File(System.getProperty("user.dir") + "/ObjectRepository/extent-config.xml");
	...
	public void setup() throws Exception {
		...
		prop = new Properties();
		System.getenv("env.agentName");
		System.out.println(System.getProperty("env.agentName"));
    	...
    	public static ExtentReports ExtentReportConfig(ITestContext context) throws IOException {
    		if (extent == null) {
    			...
    			System.getProperty("user.dir") + "/Reports/ARC_UITestingReport_" + SuiteName + ".html");
